...
packageRoutes.post("/packages", validateDto(createPackageDto), createPackage);
packageRoutes.get("/packages", authMiddleware,getPackageByRole);
packageRoutes.put("/packages/:id", validateDto(editPackageDto),editPackage);
