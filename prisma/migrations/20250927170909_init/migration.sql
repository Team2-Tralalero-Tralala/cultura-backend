...
CREATE TABLE `homestays` (
    ...
    `ht_detail` VARCHAR(200) NOT NULL,

    INDEX `homestays_st_community_id_idx`(`st_community_id`),
    INDEX `homestays_st_location_id_idx`(`st_location_id`),
    PRIMARY KEY (`ht_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `communities` (
    ...
    `ct_bank_account_id` INTEGER NOT NULL,
    ...
    UNIQUE INDEX `communities_ct_admin_id_key`(`ct_admin_id`),
    UNIQUE INDEX `communities_ct_bank_account_id_key`(`ct_bank_account_id`),
    ...
    INDEX `communities_ct_bank_account_id_idx`(`ct_bank_account_id`),
    PRIMARY KEY (`ct_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `bank_accounts` (
    ...
    `ba_bank_name` VARCHAR(45) NOT NULL,
    `ba_account_name` VARCHAR(45) NOT NULL,
    `ba_account_number` VARCHAR(45) NOT NULL,
...
CREATE TABLE `packages` (
    ...
    `pk_status_approve` ENUM('PENDING', 'APPROVE', 'PENDING_SUPER') NULL,
...
CREATE TABLE `users` (
    ...
    `us_member_of_community` INTEGER NULL,
...
CREATE TABLE `feedback_images` (
    ...
    UNIQUE INDEX `feedback_images_fi_feedback_id_key`(`fi_feedback_id`),
...
-- AddForeignKey
ALTER TABLE `store_image` ADD CONSTRAINT `store_image_si_store_id_fkey` FOREIGN KEY (`si_store_id`) REFERENCES `stores`(`st_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `homestay_images` ADD CONSTRAINT `homestay_images_hi_homestay_id_fkey` FOREIGN KEY (`hi_homestay_id`) REFERENCES `homestays`(`ht_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `homestays` ADD CONSTRAINT `homestays_st_community_id_fkey` FOREIGN KEY (`st_community_id`) REFERENCES `communities`(`ct_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `homestays` ADD CONSTRAINT `homestays_st_location_id_fkey` FOREIGN KEY (`st_location_id`) REFERENCES `locations`(`lt_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `community_images` ADD CONSTRAINT `community_images_ci_commuinty_id_fkey` FOREIGN KEY (`ci_commuinty_id`) REFERENCES `communities`(`ct_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `communities` ADD CONSTRAINT `communities_ct_bank_account_id_fkey` FOREIGN KEY (`ct_bank_account_id`) REFERENCES `bank_accounts`(`ba_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `package_files` ADD CONSTRAINT `package_files_pf_package_id_fkey` FOREIGN KEY (`pf_package_id`) REFERENCES `packages`(`pk_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `packages` ADD CONSTRAINT `packages_pk_community_id_fkey` FOREIGN KEY (`pk_community_id`) REFERENCES `communities`(`ct_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `packages` ADD CONSTRAINT `packages_pk_location_id_fkey` FOREIGN KEY (`pk_location_id`) REFERENCES `locations`(`lt_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `packages` ADD CONSTRAINT `packages_pk_create_by_fkey` FOREIGN KEY (`pk_create_by`) REFERENCES `users`(`us_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `packages` ADD CONSTRAINT `packages_pk_overseer_member_id_fkey` FOREIGN KEY (`pk_overseer_member_id`) REFERENCES `users`(`us_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `users` ADD CONSTRAINT `users_us_member_of_community_fkey` FOREIGN KEY (`us_member_of_community`) REFERENCES `communities`(`ct_id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `feedback_images` ADD CONSTRAINT `feedback_images_fi_feedback_id_fkey` FOREIGN KEY (`fi_feedback_id`) REFERENCES `feedbacks`(`fb_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `booking_histories` ADD CONSTRAINT `booking_histories_bh_tourist_bank_account_id_fkey` FOREIGN KEY (`bh_tourist_bank_account_id`) REFERENCES `bank_accounts`(`ba_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `tag_homestays` ADD CONSTRAINT `tag_homestays_tght_homestay_id_fkey` FOREIGN KEY (`tght_homestay_id`) REFERENCES `homestays`(`ht_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `tags_packages` ADD CONSTRAINT `tags_packages_tgpk_package_id_fkey` FOREIGN KEY (`tgpk_package_id`) REFERENCES `packages`(`pk_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `tag_stores` ADD CONSTRAINT `tag_stores_tgst_store_id_fkey` FOREIGN KEY (`tgst_store_id`) REFERENCES `stores`(`st_id`) ON DELETE CASCADE ON UPDATE CASCADE;
